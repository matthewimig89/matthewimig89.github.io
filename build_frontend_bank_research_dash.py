                ...
                <div id="home" class="tab-content active">
                    <div class="documentation">
                        ...
                        <ol>
                            ...
                            <li><strong>Industry-Specific Historical Distributions:</strong> Rather than comparing valuations against the broad market, your model contextualizes each company's valuation within its industry-specific historical distribution, creating more relevant comparisons.</li>
                            <li><strong>Comprehensive Quality Framework Integration:</strong>  Your model uniquely combines multiple established quality frameworks (Piotroski, Greenblatt, Graham, Grantham, Mohanram) rather than relying on just one approach, creating a more robust quality assessment.</li>
